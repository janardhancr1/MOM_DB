...
IF OBJECT_ID('MOM_ALBM') IS NOT NULL
	DROP TABLE MOM_ALBM
	
CREATE TABLE MOM_ALBM
(
	  ID		INT IDENTITY(1,1)
	, MOM_USR_ID	BIGINT
	, TITLE		NVARCHAR (255)
...
IF OBJECT_ID('MOM_ALBM_PHTO') IS NOT NULL
	DROP TABLE MOM_ALBM_PHTO

CREATE TABLE MOM_ALBM_PHTO
(
	  ID		INT IDENTITY(1,1)
	, MOM_ALBM_ID	INT
...
IF OBJECT_ID('MOM_VID') IS NOT NULL
	DROP TABLE MOM_VID

CREATE TABLE MOM_VID
(
	  ID		INT IDENTITY (1,1)
	, MOM_USR_ID	BIGINT
	, TITLE		NVARCHAR (255)
